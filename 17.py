...
"""attack_pairsの中に1ターンに使えるエナジー以上を要求する組み合わせがないか確かめる。あったら抜き出しリストmiに代入する。(miは現在使用されていない)redはreductionからきた変数で、これが起きた際にいくら打点が減るかを表すμ(a)である。Bは最終的な計算結果、PAは17式の計算の最後のS/t(1-P(a1)-P(a2\a1)-...)のP(a1)-P(a2\a1)-...の部分である。"""
mi = []
red = 0
B = 0
PA = 1
